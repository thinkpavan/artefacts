...
<%
      ...
      Connection con=DriverManager.getConnection("jdbc:oracle:thin:@127.0.0.1:1521:tit","scott","tiger");;
      out.println("Connected to Oracle<br>");
      String url="select  empno,ename,job,sal,deptno from emp";
      Statement stmt=con.createStatement(url);
