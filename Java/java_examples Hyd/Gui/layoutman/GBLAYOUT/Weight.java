...
weight), This is going to take efect if the container size is
greater than componenets size
Author : Team - J
Version : 1.0
*/
...
double weighty, int anchor, int fill, Insets insets,
 int ipadx, int ipady)*/
	...
	mywin.add(new Button("A very very big component"),new GridBagConstraints(GridBagConstraints.RELATIVE,0,1,1,0.2,0,GridBagConstraints.NORTH,GridBagConstraints.HORIZONTAL,new Insets(0,0,0,0),0,0));
	//mywin.add(new Button("A very very big component"),new GridBagConstraints(GridBagConstraints.RELATIVE,0,1,1,0,0.2,GridBagConstraints.NORTH,GridBagConstraints.HORIZONTAL,new Insets(0,0,0,0),0,0));
