/*  shows how to use Grid Bag layout manager (Anchoring a component 
and gridx,gridy)
Author : Team - J
Version : 1.0
*/
...
double weighty, int anchor, int fill, Insets insets,
 int ipadx, int ipady)*/
	...
	mywin.add(new Button("A very very big component"),new GridBagConstraints(GridBagConstraints.RELATIVE,0,1,1,0,0,GridBagConstraints.CENTER,GridBagConstraints.NONE,new Insets(0,0,0,0),0,0));
