...
// home method corresponsing to getNOS
  public int  ejbHomeGetNOS(){
	...
	try{
		...
		System.out.println("ejb home method failed " + e);
	}
	return nos;
  }
  // ejbSelect methods
  abstract public Collection ejbSelectGetCount() throws javax.ejb.FinderException;
  //abstract public ResultSet ejbSelectGetCount() throws javax.ejb.FinderException;
