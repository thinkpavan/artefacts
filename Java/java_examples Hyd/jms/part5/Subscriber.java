...
{
///// observe the change here, configure yu jms fact with client id.
  String connfactname="jmsfact2";
...
/// observe the change in code here.
    tsubscriber = tsession.createDurableSubscriber(topic,"cliidentity");
System.out.println("create durable subscription");
System.in.read();
System.in.read();
