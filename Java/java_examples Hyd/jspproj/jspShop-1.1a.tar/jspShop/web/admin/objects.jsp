...
*/
    ...
    if (mode == null)
    {
        pageURL = "/admin/templates/object/browse.jsp";
    }
    else if (mode.equals("add"))
    {
        pageURL = "/admin/templates/object/add.jsp";
    }
    else if (mode.equals("delete"))
    {
        pageURL = "/admin/templates/object/delete.jsp";
    }
    else if (mode.equals("create"))
    {
        pageURL = "/admin/templates/object/create.jsp";
    }
    else if (mode.equals("addPropertyValue"))
    {
        pageURL = "/admin/templates/object/addpropertyvalue.jsp";
    }
    else if (mode.equals("changePropertyValue"))
    {
        pageURL = "/admin/templates/object/changepropertyvalue.jsp";
    }
    else if (mode.equals("addTypeValue"))
    {
        pageURL = "/admin/templates/object/addtypevalue.jsp";
    }
    else if (mode.equals("changeTypeValue"))
    {
        pageURL = "/admin/templates/object/changetypevalue.jsp";
    }
    else
    {
        pageURL = "/admin/templates/object/browse.jsp";
...
<div align="center"> 
  <table width="100%" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td><img src="images/objectopen.jpg" width="85" height="45"></td>
              ...
              <p> 
                ...
                <% 
                    ...
                    */
                    ...
                    String url = "http://" + server + request.getContextPath() + "/admin/objectBrowse.jsp";
                    String clickURL = "http://" + server + request.getContextPath() + "/admin/objects.jsp";
				...
				WIDTH = 250 HEIGHT = 450  codebase="http://java.sun.com/products/plugin/1.3.1/jinstall-131-win32.cab#Version=1,3,1,0">
                  ...
                  <PARAM NAME = "ClickParam" VALUE="objectID">
                  ...
                  <COMMENT> <EMBED type="application/x-java-applet;jpi-version=1.3.1"  CODE = com.submersion.jspshop.adminbrowse.AdminBrowse ARCHIVE = objectBrowse.jar WIDTH = 250 HEIGHT = 450 URL = "<%=url%>" URLParam = "context"  ClickURL="<%=clickURL%>" ClickParam = "objectID" Path="<%=request.getParameter("path") %>" ModeParam = "mode" AddMode = "add" DeleteMode = "delete" scriptable=false pluginspage="http://java.sun.com/products/plugin/1.3.1/plugin-install.html">
                    <NOEMBED> </NOEMBED> 
                  </EMBED> </COMMENT> 
                </OBJECT> 
              </p>
