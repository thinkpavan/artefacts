...
<class:delete id="<%=request.getParameter(\"className\")%>" />
<%
    String url = "";
    String server = "";
    ...
    if (request.isSecure())
    {
        url = "https://" + server + request.getContextPath() + "/admin/classes.jsp";
    }
    else
    {
        url = "http://" + server + request.getContextPath() + "/admin/classes.jsp";
    }
%>
<HTML>
<BODY>
