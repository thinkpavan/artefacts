...
#
#    $Id: computers-del.php,v 1.2 2001/06/29 04:07:13 theatrus Exp $
#
################################################################################
#                                  CHANGELOG                                   #
################################################################################
...
AuthCheck("tech");
header("Location: $USERPREFIX/computers-index.php");

$track = new Tracking();
$trackIDs = $track->getByComputerID($ID);
...
$count = $adb->dbh_do($query);
logevent($ID, "computers", 4, "database", "$IRMName deleted record"); 
?>
