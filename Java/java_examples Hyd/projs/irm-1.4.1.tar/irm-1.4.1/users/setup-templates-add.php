...
#
#    $Id: setup-templates-add.php,v 1.2 2001/06/29 04:07:13 theatrus Exp $
#
################################################################################
#                                  CHANGELOG                                   #
################################################################################
...
$query = "INSERT INTO templates VALUES (NULL,'$templname', '$name',
		'$type', '$flags_server','$os', '$osver', '$processor', '$processor_speed',
...
if ($result != 1)
{
  commonHeader("IRM Setup - Add Error");
  PRINT "SQL Error.";
  PRINT "<P>QUERY: -$query- ";
