...
#
#    $Id: computers-update.php,v 1.2 2001/06/29 04:07:13 theatrus Exp $
#
################################################################################
#                                  CHANGELOG                                   #
################################################################################
...
$query = "REPLACE computers VALUES ($ID, '$name', '$type','$flags_server' ,'$os', '$osver',
...
logevent($ID, "computers", 4, "database", "$IRMName updated record");
