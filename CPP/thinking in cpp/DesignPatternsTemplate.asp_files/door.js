...
gKL[i]=cpl(gK[i]);
function pKWL(){
aAD.push(new iA(2471511,'application','AMD Virtual Tradeshow','Learn about the latest products from AMD and their partners including Microsoft, IBM, Sun and Oracle. Receive  Downloads, Free Whitepapers, Prizes & More.','','www%2eAMD%2ecom','','',2,0,0,'','','f4193607-b701-4852-a33c-e58c35fd94bd','50da38f65c283574ce7cfc7aa1ea4399',0,0,2,0,0,0,0.032,0,'','','','',0,0,'',0, 60000, 0));
 itxtprep();
 hIT(aAD,aKW,gSI,0);
}
...
gTI='';
gSI=1;
gSID='e166a8a370ee8fa3a435efa8a715c5f8';
mTL=50;
gDrag=1;
gOFlt=0;
gIRB=0;
...
sKPs='~',
sKFs='|',
sRU='http://www.codeproject.com/useritems/DesignPatternsTemplate.asp',
gMR=1000,
bWAC=0,
bYCR=0,
gMNC=255,
